...
def independence_test(X, Y, conditioned_on=None, method="kernel", **kwargs):
    ...
    * `regression`: Regression based (conditional) independence test using a f-test. See :func:`~gcm.regression_based` for more details.

    * `gcm`: (Conditional) independence test based on the Generalised Covariance Measure. See :func:`~gcm.generalised_cov_based` for more details.
    ...
    :param method: Method for conditional independence test. The choices are:
                   `kernel` (default): :func:`~gcm.kernel_based` (conditional) independence test.
                   `approx_kernel`: :func:`~gcm.approx_kernel_based` (conditional) independence test.
                   `regression`: :func:`~gcm.regression_based` (conditional) independence test.
                   `gcm`: :func:`~gcm.generalised_cov_based` (conditional) independence test.
