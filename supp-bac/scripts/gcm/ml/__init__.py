"""This module defines implementations of :class:`~gcm.fcms.PredictionModel` used by the different
:class:`~gcm.graph.FunctionalCausalModel` implementations, such as :class:`~gcm.fcms.PostNonlinearModel` or
:class:`~gcm.fcms.AdditiveNoiseModel`.
"""
