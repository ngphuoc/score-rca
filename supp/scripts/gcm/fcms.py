"""This module defines multiple implementations of the abstract class :class:`~gcm.graph.FunctionalCausalModel`
(FCM)
...
from gcm.graph import FunctionalCausalModel, InvertibleFunctionalCausalModel, StochasticModel
from gcm.util.general import is_categorical, shape_into_2d
...
class AdditiveNoiseModel(PostNonlinearModel):
    ...
    def __init__(self, prediction_model: PredictionModel, noise_model: Optional[StochasticModel] = None) -> None:
        ...
        from gcm.ml.regression import InvertibleIdentityFunction
...
class ClassifierFCM(FunctionalCausalModel, ProbabilityEstimatorModel):
    ...
    def __init__(self, classifier_model: Optional[ClassificationModel] = None) -> None:
        ...
        if classifier_model is None:
            from gcm.ml.classification import create_hist_gradient_boost_classifier
