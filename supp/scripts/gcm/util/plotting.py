...
def plot(
    ...
    **kwargs,
    ...
    """Deprecated, please use utils.plot() instead."""
    warnings.warn(
        "The plot method is deprecated. Use the plot function from utils.plotting instead!", DeprecationWarning
    )
    plot(
...
def plot_adjacency_matrix(
    ...
    """Deprecated, please use utils.plot_adjacency_matrix() instead."""
    warnings.warn(
        "The plot method is deprecated. Use the plot_adjacency_matrix function from utils.plotting instead!",
        DeprecationWarning,
    )
...
def bar_plot(
    ...
    """Deprecated, please use utils.bar_plot() instead."""
    warnings.warn(
        "The plot method is deprecated. Use the bar_plot function from utils.plotting instead!",
        DeprecationWarning,
    )
    bar_plot(
        values=values,
