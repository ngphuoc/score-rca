...
from gcm.constant import EPS
from gcm.density_estimator import DensityEstimator
...
class RescaledMedianCDFQuantileScorer(AnomalyScorer):
    ...
    This is a rescaled version of the score s obtained by the :class:`~gcm.anomaly_scorers.MedianCDFQuantileScorer`
...
class InverseDensityScorer(AnomalyScorer):
    ...
    def __init__(self, density_estimator: Optional[DensityEstimator] = None):
        if density_estimator is None:
            from gcm.density_estimators import GaussianMixtureDensityEstimator
