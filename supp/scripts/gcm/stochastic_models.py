"""This module defines multiple implementations of the abstract class :class:`~gcm.graph.StochasticModel`.
...
from gcm.divergence import estimate_kl_divergence_continuous
from gcm.graph import StochasticModel
